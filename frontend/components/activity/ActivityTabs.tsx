...
const TABS: Tab[] = [
    ...
    { id: 'tab-includes', label: 'Includes' },
    { id: 'tab-knowbefore', label: 'Know Before You Go' },
...
export default function ActivityTabs() {
    ...
    return (
        <nav className="sticky top-[57px] z-[80] bg-white border-b border-gray-200 shadow-sm">
