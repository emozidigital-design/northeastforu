...
export const HERO_SLIDES = [
    {
        ...
        location: 'Assam',
        title: 'Wild Assam Awaits',
        subtitle: 'One-horned rhinos, the mighty Brahmaputra & ancient temples — the gateway to North East India.',
    },
    {
        ...
        subtitle: 'Living root bridges, cascading waterfalls & the world\'s wettest villages — Meghalaya is pure magic.',
    },
    {
        ...
        subtitle: 'High-altitude monasteries, untouched tribal cultures & Himalayan passes that take your breath away.',
    },
    {
        src: '/images/nagaland/nagaland-1.jpg',
        label: 'Vibrant Hornbill & Naga Heritage',
        location: 'Nagaland',
        title: 'Festival of the Nagas',
        subtitle: 'Where ancient warrior culture meets vibrant traditions — experience India\'s most electrifying festival.',
    },
    {
        ...
        subtitle: 'Sacred glacial lakes, ancient Buddhist monasteries & views of the third-highest peak on Earth.',
    },
    {
        ...
        subtitle: 'The floating islands of Loktak Lake, classical dance, and landscapes that defy imagination.',
    },
    {
        ...
        subtitle: 'Serene valleys, warm Mizo hospitality & a landscape painted in a thousand shades of green.',
    },
    {
        src: '/images/tripura/tripura-1.jpg',
        label: 'The Royal Ujjayanta Palace',
        location: 'Tripura',
        title: 'Royalty & Wilderness',
        subtitle: 'Regal palaces, sacred temples and dense jungle reserves — Tripura\'s hidden heritage is waiting.',
    },
];
